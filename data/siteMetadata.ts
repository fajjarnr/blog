...
const siteMetadata: PlinyConfig = {
  ...
  siteUrl: process.env.SITE_URL || 'https://your-cloudflare-pages-url.pages.dev',
  ...
  analytics: {
    ...
    umamiAnalytics: {
      ...
      umamiWebsiteId: process.env.NEXT_UMAMI_ID as string, // e.g. 123e4567-e89b-12d3-a456-426614174000
